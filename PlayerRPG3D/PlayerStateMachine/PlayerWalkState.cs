...
public partial class PlayerWalkState : PlayerState, IState
{
	...
	{
		GD.PrintT("CS Walk State Entered");
	}
	...
	private void ManageWalkState(double delta)
	{
		...
		if (characterNode != null)
		{
			...
			{
				GD.PrintT("Jump Pressed from walk state");
				TransitionToJump();
			}
	...
	private void TransitionToIdle()
	{
		...
		{
			EmitStateTransition(this, Constants.PLAYER_IDLE_STATE, characterNode);
	...
	private void TransitionToJump()
	{
		if (characterNode != null)
		{
			EmitStateTransition(this, Constants.PLAYER_JUMP_STATE, characterNode);
			//direction = Vector2.Zero;
		}
	}
